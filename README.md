...
These are Frontier-only package measurements for @shapeshift-labs/frontier-lang-clang. They exercise only this package's importer wrapper and semantic sidecar helpers without making competitor comparison claims.
